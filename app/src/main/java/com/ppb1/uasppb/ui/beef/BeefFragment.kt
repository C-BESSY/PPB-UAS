...
import com.ppb1.uasppb.databinding.FragmentBeefBinding


class BeefFragment : Fragment() {

    private var _binding: FragmentBeefBinding? = null
    ...
    override fun onCreateView(
        ...
        ViewModelProvider(this)[BeefViewModel::class.java]
        _binding = FragmentBeefBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView= binding.rvBeef
        progressBar= binding.pgBeef
    ...
    private fun fetchData(){
        ...
        val url = "https://www.themealdb.com/api/json/v1/1/filter.php?c=Beef"
